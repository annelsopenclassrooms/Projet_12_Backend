    ...
    while True:
        ...
        if user.role.name == "gestion":
            options = [
                ...
                ("5", "Créer un contrat", create_contract_view),
                ("6", "Modifier un contrat", update_contract_view),
                ("7", "Lister les contrats", show_all_contracts_view),
                ("8", "Modifier un événement (attribuer support)", update_event_view),
